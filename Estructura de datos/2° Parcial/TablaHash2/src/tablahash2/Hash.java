...
import static tablahash2.Hash.funcion;
...
//    static int Colision(Hash[] h, int m, int n){
//        while(Colision[Hash])(h, m, n){
//                  Colision++;
//                  javax.swing.JOptionPane.showMessageDialog(null, "Ocurrio una colision en el indice "+(Hash-1)+" Cambiar al indice "+Hash);
//                  Hash%=(h, m, n);
//    }
}